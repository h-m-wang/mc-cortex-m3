...
if { ! [info exists IP_FILES] } {
  set IP_FILES {"E:/Project/FPGA_altera/AG16KSDE176_DemoBoard/src/mcu.ip" }
}
if { ! [info exists VE_FILE] } {
  set VE_FILE "E:/Project/FPGA_altera/AG16KSDE176_DemoBoard/src/top.ve"
}
